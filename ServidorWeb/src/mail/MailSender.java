...
public class MailSender {
	...
	public void sendMail(String usuario, String password) throws Exception{
		try {

			Message message = new MimeMessage(getSession());
			message.setFrom(new InternetAddress(userName));
			message.setRecipients(Message.RecipientType.TO,InternetAddress.parse(usuario));
			message.setSubject("RECUPERACION PASSWORD DSOFTWARE");
			message.setText("Tu nueva password es: "+ password + " \n \nACUERDATE DE CAMBIARLA");
